...
export class AdeudosClienteComponent implements OnInit{
  ...
  constructor(private adeudoservice:AdeudosService,@Inject(MAT_DIALOG_DATA) public data: ClienteModel,public dialog: MatDialog)
  {
  ...
  public getAllAdeudos(){
    this.adeudoservice.getAllAdeudos(`https://localhost:7125/api/registroadeudo/deudas/${this.cliente.id}`).subscribe(Response =>{
